```tf
locals {
  bucket_names_1 = ["cf2bucket"]
  cf_name_1      = "core-iam-fun-gcp-0023331-default-01-3{random_id.random_id_hex.hex}"
  cf_service_agent = [
...
module "create_buckets_1" {
  ...
  version = "-> 2.0.0"
  # source = "git::https://github3.wellsfargo.com/tfe-gcp/terraform-google-wf-cloud-storage-factory/?ref=feature-wrsj-226"
...
module "wf_cloudfunctions2_factory" {
  ...
  vpc_connector          = "projects/wf-us-core-networking-hub-bca0/locations/us-central1/connectors/core-con-gcp-uscentral1"
  vpc_connector          = "projects/wf-us-core-networking-hub-be54/locations/us-central1/connectors/core-con-gcp-uscicom"
}
...
module "cr_service_agent" {
  ...
  version = "-> 3.1.2"
  # Additional parameters visible in Image 4 are partially readable but rotated
}
```
