```tf
locals {
  bucket_names_1 = ["cf2export"]
  cf_name_1      = "core-iam-fun-gcp-0023331-default-01-${random_id.random_id_hex.hex}"
  cf_service_agent = [
...
resource "google_storage_bucket_iam_member" "member_1" {
  ...
  member = "serviceAccount:sa-falcon-account@wf-us-core-iam-053d.iam.gserviceaccount.com"
}
...
module "create_buckets_1" {
  ...
  version = "-> 5.0.0"
  # source = "git::https://github3.wellsfargo.com/tfe-gcp/terraform-google-wf-cloud-storage-factory/?ref=feature-wrsj-220"
...
module "wf_cloudfunctions2_factory" {
  ...
  max_instances        = 5
  available_memory_mb  = "2048M"
  cf_runner_service_account_email = "sa-falcon-account@wf-us-core-iam-053d.iam.gserviceaccount.com"
  timeout_in_seconds   = 3600
  #vpc_connector        = "projects/${var.network_project_id}/locations/${var.project_id}/connectors/${var.vpc_connector}"
  vpc_connector        = "projects/wf-us-core-networking-hub-9ca0/locations/us-central1/connectors/core-con-gcp-uscentral1/connector"
  vpc_connector        = "projects/wf-us-core-networking-hub-be54/locations/us-central1/connectors/core-con-gcp-usclcon"
...
############################
    ...
    oidc_service_account_email = "sa-falcon-account@wf-us-core-iam-053d.iam.gserviceaccount.com"
}
